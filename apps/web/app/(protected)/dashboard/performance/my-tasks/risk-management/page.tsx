    ...
    <div className="p-8 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 mt-1">Identify, assess, and manage risks for your department</p>
        </div>
        <div className="flex gap-3">
          ...
          <Button onClick={() => setAddRiskDialogOpen(true)}>
          ...
          <div className="space-y-3 pt-4">
            <Button 
              ...
              onClick={() => {
                ...
                router.push('/dashboard/performance/my-tasks/risk-management/create')
              }}
            >
