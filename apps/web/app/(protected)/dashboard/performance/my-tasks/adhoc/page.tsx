  ...
  const handleCreate = async () => {
    try {
      ...
      if (response.ok) {
        ...
        // Get raw text first to see what the server actually returned
        const rawText = await response.text()
        console.error('Failed to create task - Raw response:', rawText)
    ...
    <div className="p-8 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 mt-1">Quick tasks and requests</p>
        </div>
